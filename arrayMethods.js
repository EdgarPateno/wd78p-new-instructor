...
// IsArray method - checks if an object is an array

const array = ["edgar", "shella", "kelly", "kerry", "james", "david", "ray", "john", "michael"];

let isArray = Array.isArray(array);
console.log('This is isArray method: ' + isArray);
...
// REDUE METHOD - reduces an array to a single value


// FILTER METHOD - creates a new array with all elements that pass a test (provided as a function)


// SOME METHOD - checks if an array contains elements that pass just one test (provided as a function)
// returns true or false
// Parameter = a function


// EVERY METHOD - checks if an array contains elements that pass ALL the test (provided as a function)
// returns true or false
// Parameter = a function
